                        ...
                        <form action="<?php echo e(route('paiements.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type_frais" class="form-select" required>
                                    ...
                                    <option value="scolarite">Frais de Scolarité (Écolage)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge <?php echo e($paiement->type_frais == 'inscription' ? 'bg-info' : 'bg-dark'); ?> text-white text-capitalize">
                                                <?php echo e($paiement->type_frais); ?>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center text-muted small py-4">Aucun versement ne correspond à votre recherche.</td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
...
</html><?php /**PATH C:\laragon\www\gestion-ecole\resources\views/paiements/index.blade.php ENDPATH**/ ?>