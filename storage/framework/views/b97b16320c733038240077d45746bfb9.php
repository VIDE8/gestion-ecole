        ...
        <div class="card-body p-5">
            ...
            <form action="<?php echo e(url('/login')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control form-control-custom" placeholder="votre email" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
                <div class="mb-4">
...
</html><?php /**PATH C:\laragon\www\Code_Source_Gestion_Scolaire_VIDE_Kossi\resources\views/auth/login.blade.php ENDPATH**/ ?>